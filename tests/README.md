...
| Voz con ElevenLabs y llamadas de Sara | `test_voz_elevenlabs.py`, `test_captacion_voz.py`, `test_lanzador_llamadas.py` — a quién NO se llama y que sin Lista Robinson no suena nadie |
