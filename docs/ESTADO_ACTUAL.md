...
- **Tarea:** candidato **bec310f desplegado en producción** el 14-sep a las 07:22 (VERSION.json 2360b1c, `main` subido) por orden de Pablo, con la exigencia de dos apellidos activa para Alicia; vigilar cómo funciona con clientas reales. Astra sin créditos hasta el 13-oct.
...
- **Siguiente (Claude):** vigilar las conversaciones reales de Alicia en cuanto lo use (frenos en `agent_turns`, citas creadas, dos apellidos); fase 4 del plan con el inventario de frenos; pendientes menores (vacaciones dice «agenda completa»; `horario-escrito-manda` depende del día). Externo: WhatsApp de Alicia sin conectar (bloquea recordatorios).
- **En curso (Astra, 14-sep 10:41 Europe/Madrid):** stra/reconciliar-pendientes desde main 4da10e recupera operaciones internas de creación cuyo resultado quedó perdido: solo tras 15 min, sin cita y sin webhook; WhatsApp no recrea nada, ofrece un resumen nuevo. La revisión de `5c88bc7` encontró una carrera conversación/operación; corrección en curso en esta rama: 21 regresiones dirigidas verdes en 45,18 s. Siguiente: commit y segunda revisión de Claude. Sin despliegue.
