...
- **En curso (Astra, 14-sep 10:41 Europe/Madrid):** stra/reconciliar-pendientes desde main 4da10e recupera operaciones internas de creación cuyo resultado quedó perdido: solo tras 15 min, sin cita y sin webhook; WhatsApp no recrea nada, ofrece un resumen nuevo. 19 regresiones dirigidas verdes; siguiente: commit y revisión de Claude. Sin despliegue.
