...
- **En curso (Astra, 14-sep 10:41 Europe/Madrid):** stra/reconciliar-pendientes desde main 4da10e recupera operaciones internas de creación cuyo resultado quedó perdido: solo tras 15 min, sin cita y sin webhook; WhatsApp no recrea nada, ofrece un resumen nuevo. La revisión de `5c88bc7` encontró una carrera conversación/operación; corrección `5a965e7`: 50 regresiones dirigidas verdes en 51,63 s. Espera a: segunda revisión de Claude; sin despliegue.
