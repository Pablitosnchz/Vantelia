...
- **Siguiente:** fase 5 (candidato integrado y medicion comparable) y la identidad por aviso, que es lo que falta para conectar los avisos a la admision de salidas. Sigue sin desplegarse nada: lo desplegado es `0cb61de`.
