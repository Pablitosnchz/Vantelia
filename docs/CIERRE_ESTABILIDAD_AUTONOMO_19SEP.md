...
| 2 — parcial | Chat/transportes/pago y widget integrados. Correcciones de suite `2ec42a5`, widget asíncrono `00d628a` y WA1 `fd833b4` revisados e integrados hasta `f4ffd2c`. WA1: 172 dirigidos; widget: 16 Node y Chrome. Captura durable WA2a en implementación; webhook y Flows pendientes. | Pausar antes del modelo y durante su respuesta; impedir efectos nuevos si gana la pausa, conservar los ya admitidos; pausa/reactivación no revive trabajo viejo; fragmentos y callbacks cubiertos; dos tenants. |
