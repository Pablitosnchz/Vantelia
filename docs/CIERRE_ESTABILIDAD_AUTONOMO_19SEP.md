...
| 2 — parcial | 2a `6458b5` y 2b `f6c16e1` integradas. Chat/transportes `fc8f58e` y pago conocido `56c3f3b` integrados hasta `83bed95`, revisión exacta OK y 63 dirigidos combinados. Widget y CI integrados. WhatsApp y Flows siguen pendientes; WA1 se prueba en rama aparte. | Pausar antes del modelo y durante su respuesta; impedir efectos nuevos si gana la pausa, conservar los ya admitidos; pausa/reactivación no revive trabajo viejo; fragmentos y callbacks cubiertos; dos tenants. |
