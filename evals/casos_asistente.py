...
CASOS = [
    ...
    # ─── La prueba de la duenya por WhatsApp, 15-sep-2026 ──────────────────
    {
        ...
        "mensajes": ["Quiero coger una cita para hacerme unas mechas",
                     ...
                     # (test_calendario_de_las_medidas) y «a primera hora» es «me da igual,
                     # la primera que tengas» (reserva.py): mismo sentido sin ninguna de las dos.
                     "Pues quiero un grey blindin", "Medio", "Y prefiero antes de mediodia",
